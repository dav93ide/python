...
pygame.display.set_caption(joystick[0].get_name())
...
def draw_axis( surface, x, y, axis_x, axis_y, size):
	...
	for n in xrange(num_lines):
		...
		pygame.draw.lines(surface, line_col, (x+n*step, y), (x+n*step, y+size))
		pygame.draw.lines(surface, line_col, (x, y+n*step), (x+size, y+n*step))
